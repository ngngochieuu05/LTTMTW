...
namespace GUI
{
    public partial class QuanLiSinhVien_NgNgocHieu : Form
    {
        private StudentService studentService = new StudentService();
        private string duongDanAnh = null;

        public QuanLiSinhVien_NgNgocHieu()
        {
            InitializeComponent();
        }
        ...
        private void btnChonAnh_Click(object sender, EventArgs e)
        {
            try
            {
                using (OpenFileDialog openFile = new OpenFileDialog())
                {
                    ...
                    openFile.Title = "Chon anh dai dien";
                    if (openFile.ShowDialog() == DialogResult.OK)
                    {
                        picAnhDaiDien.Image = System.Drawing.Image.FromFile(openFile.FileName);
            ...
            {
                MessageBox.Show("Loi khi chon anh: " + ex.Message, "Loi",
                    MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
